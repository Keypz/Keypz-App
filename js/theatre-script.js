...
function getnearEvents(page) {
  ...
  $.ajax({
    type:"GET",
    url:"https://app.ticketmaster.com/discovery/v2/events.json?apikey=ffAGGpR07MXTUwMB3ZcwknFfqo6GeYWW&source=ticketmaster&classificationName=theatre&marketId=202&size=4&page="+page,
    async:true,
    dataType: "json",
...
function getAttraction(id) {
  $.ajax({
    type:"GET",
    url:"https://app.ticketmaster.com/discovery/v2/attractions/"+id+".json?apikey=ffAGGpR07MXTUwMB3ZcwknFfqo6GeYWW&source=ticketmaster&classificationName=theatre&marketId=202",
    async:true,
    dataType: "json",
    success: function(json) {
          showAttraction(json);
